//
//  TWCollectionLayoutViewController.m
//  iOSLearning
//
...
#import "TWCollectionLayout.h"

@interface TWCollectionLayoutViewController ()<UICollectionViewDelegate,UICollectionViewDataSource>

@property (strong, nonatomic)UICollectionView *collection;
@property (strong, nonatomic)TWCollectionLayout *layout;
@end

@implementation TWCollectionLayoutViewController
...
- (TWCollectionLayout *)layout {
    if (!_layout) {
        _layout = [[TWCollectionLayout alloc]init];
...
{
    if (!_collection) {
        _collection = [[UICollectionView alloc]initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT) collectionViewLayout:self.layout];
